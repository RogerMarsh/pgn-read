...
class PointToPoint(unittest.TestCase):
    def verify_square_combination(self, sq1, sq2):
        ...
        if f1 == f2:
            ae(
                ref[2] is constants.FILE_ATTACKS[sq1][1],
                True,
                " ".join(
                    (
            ...
            ae(
                ref[2] is constants.RANK_ATTACKS[sq1][1],
                True,
                " ".join(
                    (
                        "POINT_TO_POINT" + repr([sq1, sq2]) + "[2]",
            ...
            ae(
                ref[2] is constants.LRD_DIAGONAL_ATTACKS[sq1][1],
                True,
                " ".join(
                    (
                        "POINT_TO_POINT" + repr([sq1, sq2]) + "[2]",
            ...
            ae(
                ref[2] is constants.RLD_DIAGONAL_ATTACKS[sq1][1],
                True,
                " ".join(
                    (
                        "POINT_TO_POINT" + repr([sq1, sq2]) + "[2]",
...
class LeftRightDownDiagonalAttacks(unittest.TestCase):
    ...
    def test_02_lrd_diagonal_attacks(self):
        ...
        for k, v in lrda.items():
            ref = v[1][0]
            ae(
                lrda[k][1] is lrda[ref][1],
                True,
                " ".join(
                    (
                        "LRD_DIAGONAL_ATTACKS[" + k + "][1]",
                        "is not",
...
class RightLeftDownDiagonalAttacks(unittest.TestCase):
    ...
    def test_02_rld_diagonal_attacks(self):
        ...
        for k, v in rlda.items():
            ref = v[1][0]
            ae(
                rlda[k][1] is rlda[ref][1],
                True,
                " ".join(
                    (
                        "RLD_DIAGONAL_ATTACKS[" + k + "][1]",
                        "is not",
...
class SourceSquares(unittest.TestCase):
    def test_01_source_squares(self):
        ...
        ai(
            css[constants.FEN_WHITE_PAWN + constants.PGN_CAPTURE_MOVE],
            constants.WHITE_PAWN_CAPTURES,
        )
        ai(
            css[constants.FEN_BLACK_PAWN + constants.PGN_CAPTURE_MOVE],
            constants.BLACK_PAWN_CAPTURES,
        )
