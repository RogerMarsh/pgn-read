# _utilities_tagpair.py
# Copyright 2023 Roger Marsh
# Licence: See LICENCE (BSD licence)

"""Utilities to run a sample module for PGNTagPair parser."""
...
from ..core.tagpair_parser import PGNTagPair


def read_pgn_count_games(filename, game_class=None, size=10000000):
    """Return ok and error counts, and PGN text in error."""
    game_count = 0
    for y in PGNTagPair(game_class=game_class).read_games(
